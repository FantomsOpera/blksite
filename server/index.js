...
app.get("/0", cors(corsOptions("0")), (req, res) => {
...
app.get("/1", cors(corsOptions("1")), (req, res) => {
...
app.get("/2", cors(corsOptions("2")), (req, res) => {
...
app.get("/3", cors(corsOptions("3")), (req, res) => {
...
app.get("/4", cors(corsOptions("4")), (req, res) => {
...
app.get("/5", cors(corsOptions("5")), (req, res) => {
...
app.get("/6", cors(corsOptions("6")), (req, res) => {
...
app.get("/7", cors(corsOptions("7")), (req, res) => {
...
app.get("/8", cors(corsOptions("8")), (req, res) => {
...
app.get("/9", cors(corsOptions("9")), (req, res) => {
...
app.get("/10", cors(corsOptions("10")), (req, res) => {
...
app.get("/11", cors(corsOptions("11")), (req, res) => {
...
app.get("/12", cors(corsOptions("12")), (req, res) => {
...
app.get("/13", cors(corsOptions("13")), (req, res) => {
...
app.get("/14", cors(corsOptions("14")), (req, res) => {
...
app.get("/15", cors(corsOptions("15")), (req, res) => {
...
app.get("/16", cors(corsOptions("16")), (req, res) => {
...
app.get("/17", cors(corsOptions("17")), (req, res) => {
...
app.get("/18", cors(corsOptions("18")), (req, res) => {
...
app.get("/19", cors(corsOptions("19")), (req, res) => {
...
app.get("/20", cors(corsOptions("20")), (req, res) => {
...
app.get("/21", cors(corsOptions("21")), (req, res) => {
...
app.get("/22", cors(corsOptions("22")), (req, res) => {
...
app.get("/23", cors(corsOptions("23")), (req, res) => {
...
app.get("/24", cors(corsOptions("24")), (req, res) => {
...
app.get("/25", cors(corsOptions("25")), (req, res) => {
...
app.get("/26", cors(corsOptions("26")), (req, res) => {
...
app.get("/27", cors(corsOptions("27")), (req, res) => {
...
app.get("/28", cors(corsOptions("28")), (req, res) => {
...
app.get("/29", cors(corsOptions("29")), (req, res) => {
