...
function corsOptions(number = "0") {
  return {
    origin: 'http://blkapi.herokuapp.com/'+number,
...
app.get("/0", cors(corsOptions("0")), function (req, res) {
...
app.get("/1", cors(corsOptions("1")), function (req, res) {
...
app.get("/2", cors(corsOptions("2")), function (req, res) {
...
app.get("/3", cors(corsOptions("3")), function (req, res) {
...
app.get("/4", cors(corsOptions("4")), function (req, res) {
...
app.get("/5", cors(corsOptions("5")), function (req, res) {
...
app.get("/6", cors(corsOptions("6")), function (req, res) {
...
app.get("/7", cors(corsOptions("7")), function (req, res) {
...
app.get("/8", cors(corsOptions("8")), function (req, res) {
...
app.get("/9", cors(corsOptions("9")), function (req, res) {
...
app.get("/10", cors(corsOptions("10")), function (req, res) {
...
app.get("/11", cors(corsOptions("11")), function (req, res) {
...
app.get("/12", cors(corsOptions("12")), function (req, res) {
...
app.get("/13", cors(corsOptions("13")), function (req, res) {
...
app.get("/14", cors(corsOptions("14")), function (req, res) {
...
app.get("/15", cors(corsOptions("15")), function (req, res) {
...
app.get("/16", cors(corsOptions("16")), function (req, res) {
...
app.get("/17", cors(corsOptions("17")), function (req, res) {
...
app.get("/18", cors(corsOptions("18")), function (req, res) {
...
app.get("/19", cors(corsOptions("19")), function (req, res) {
...
app.get("/20", cors(corsOptions("20")), function (req, res) {
...
app.get("/21", cors(corsOptions("21")), function (req, res) {
...
app.get("/22", cors(corsOptions("22")), function (req, res) {
...
app.get("/23", cors(corsOptions("23")), function (req, res) {
...
app.get("/24", cors(corsOptions("24")), function (req, res) {
...
app.get("/25", cors(corsOptions("25")), function (req, res) {
...
app.get("/26", cors(corsOptions("26")), function (req, res) {
...
app.get("/27", cors(corsOptions("27")), function (req, res) {
...
app.get("/28", cors(corsOptions("28")), function (req, res) {
...
app.get("/29", cors(corsOptions("29")), function (req, res) {
...
app.listen(PORT, () => {
  console.log(`Server listening on ${PORT}; CORS Enabled`);
});
